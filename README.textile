...
It is recommended that when importing the project to workspace you *do not copy* (do not check the copy option) so any update from git can reflect immediately to your Eclipse environment.

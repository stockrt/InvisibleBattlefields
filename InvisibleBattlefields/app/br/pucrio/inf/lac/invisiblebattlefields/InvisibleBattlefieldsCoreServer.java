package br.pucrio.inf.lac.invisiblebattlefields;
...
public class InvisibleBattlefieldsCoreServer implements
	...
	public InvisibleBattlefieldsCoreServer() {
	...
	public static JsonNode handleRequest(RequestInfo requestMessage) {
		System.out.println("[InvisibleBattlefieldsCoreServer] Request type: "
		...
		default:
			System.out
					.println("[InvisibleBattlefieldsCoreServer] Request type not recognized by server");
	...
	public void onNewData(ApplicationObject topicSample) {
		...
		System.out
				.println("[InvisibleBattlefieldsCoreServer] Mensagem recebida do cliente: "
		...
		if (className != null) {
			if (className.equals(RequestInfo.class.getCanonicalName())) {
				...
				System.out
						.println("[InvisibleBattlefieldsCoreServer] Objeto desconhecido recebido do cliente: "
								+ className);
			}
		} else {
			System.out
					.println("[InvisibleBattlefieldsCoreServer] Objeto inválido recebido do cliente");
		}
	}
}
